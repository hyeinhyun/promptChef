...
from .generation import composer, evaluate, refine, runner
from .models import (
    AutoComposeResponse,
...
from .planning import adjust_confidence, dedupe_preserve_order, planner


def compose_with_plan(
    plan: PlannerPlan, user_input: str, *, start: float | None = None
) -> ComposeAndRunResponse:
